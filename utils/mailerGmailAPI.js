...
/**
 * Envía un correo electrónico usando Gmail API con autenticación de aplicación
...
const sendMail = async (to, subject, html, attachmentPath) => {
    ...
    try {
        ...
        // Usar Gmail API con autenticación de aplicación
        const auth = new google.auth.GoogleAuth({
            credentials: {
                client_id: '526277260036-lgp3u2m0giv2dcghhvmfjefafd6ev0me.apps.googleusercontent.com',
                client_secret: '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',
