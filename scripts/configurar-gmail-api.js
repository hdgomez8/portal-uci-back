...
/**
 * Script para configurar Gmail API de forma simplificada
 * Este script configura Gmail API sin OAuth complejo
 */
...
async function configurarGmailAPI() {
    ...
    try {
        ...
        console.log('5. Ejecuta: node scripts/procesar-codigo-gmail.js [CODIGO]');
        console.log('');
        ...
        console.log('================');
        console.log('Ejecuta: node scripts/procesar-codigo-gmail.js [TU_CODIGO_AQUI]');
