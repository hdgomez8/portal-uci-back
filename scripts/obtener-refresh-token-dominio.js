...
/**
 * Script para obtener Refresh Token de Gmail API con redirect URI de dominio
 * Usa un redirect URI que funciona con dominios
 */
...
const oauth2Client = new google.auth.OAuth2(
    ...
    'https://developers.google.com/oauthplayground' // Redirect URI que funciona
);
...
async function generarURLAutorizacion() {
    console.log('🔧 GENERANDO URL DE AUTORIZACIÓN PARA GMAIL API (CON DOMINIO)');
    console.log('============================================================');
    console.log('');
    ...
    try {
        ...
        console.log('5. Ejecuta: node scripts/procesar-codigo-dominio.js [CODIGO]');
        console.log('');
        ...
        console.log('================');
        console.log('Ejecuta: node scripts/procesar-codigo-dominio.js [TU_CODIGO_AQUI]');
