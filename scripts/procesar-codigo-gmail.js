 ...
 * Uso: node scripts/procesar-codigo-gmail.js [CODIGO_DE_AUTORIZACION]
 */
...
async function procesarCodigo(codigo) {
    console.log('🔧 PROCESANDO CÓDIGO DE AUTORIZACIÓN PARA GMAIL API');
    console.log('===================================================');
    console.log('');
    ...
    if (!codigo) {
        ...
        console.log('node scripts/procesar-codigo-gmail.js [TU_CODIGO_AQUI]');
        console.log('');
        console.log('📋 EJEMPLO:');
        console.log('node scripts/procesar-codigo-gmail.js 4/0AX4XfWh...');
        return;
    }
    ...
    try {
        ...
        console.log('2. Ejecuta: node scripts/test-gmail-api.js');
