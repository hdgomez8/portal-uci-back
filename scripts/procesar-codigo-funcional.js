 ...
 * Uso: node scripts/procesar-codigo-funcional.js [CODIGO_DE_AUTORIZACION]
 */
...
async function procesarCodigo(codigo) {
    ...
    if (!codigo) {
        ...
        console.log('node scripts/procesar-codigo-funcional.js [TU_CODIGO_AQUI]');
        console.log('');
        console.log('📋 EJEMPLO:');
        console.log('node scripts/procesar-codigo-funcional.js 4/0AX4XfWh...');
        return;
    }
