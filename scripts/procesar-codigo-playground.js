 ...
 * Uso: node scripts/procesar-codigo-playground.js [CODIGO_DE_AUTORIZACION]
 */
...
async function procesarCodigo(codigo) {
    console.log('🔧 PROCESANDO CÓDIGO DE AUTORIZACIÓN PARA GMAIL API (PLAYGROUND)');
    console.log('================================================================');
    console.log('');
    ...
    if (!codigo) {
        ...
        console.log('');
        console.log('📋 EJEMPLO:');
        console.log('node scripts/procesar-codigo-playground.js 4/0AX4XfWh...');
        return;
    }
