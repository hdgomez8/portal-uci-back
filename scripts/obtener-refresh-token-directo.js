...
/**
 * Script para obtener Refresh Token de Gmail API usando método directo
 * Este método evita problemas de redirect URI
 */

const { google } = require('googleapis');

// Configuración OAuth 2.0 con método directo
const oauth2Client = new google.auth.OAuth2(
    '526277260036-lgp3u2m0giv2dcghhvmfjefafd6ev0me.apps.googleusercontent.com',
    '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',
    'urn:ietf:wg:oauth:2.0:oob' // Método directo que siempre funciona
);
...
async function generarURLAutorizacion() {
    console.log('🔧 GENERANDO URL DE AUTORIZACIÓN PARA GMAIL API (MÉTODO DIRECTO)');
    console.log('================================================================');
    console.log('');
    ...
    try {
        ...
        console.log(`Redirect URI: urn:ietf:wg:oauth:2.0:oob (Método directo)`);
        console.log('');
        ...
        console.log('5. Ejecuta: node scripts/procesar-codigo-directo.js [CODIGO]');
        console.log('');
        ...
        console.log('================');
        console.log('Ejecuta: node scripts/procesar-codigo-directo.js [TU_CODIGO_AQUI]');
