 ...
 * Uso: node scripts/procesar-codigo-directo.js [CODIGO_DE_AUTORIZACION]
 */
...
async function procesarCodigo(codigo) {
    ...
    if (!codigo) {
        ...
        console.log('node scripts/procesar-codigo-directo.js [TU_CODIGO_AQUI]');
        console.log('');
        console.log('📋 EJEMPLO:');
        console.log('node scripts/procesar-codigo-directo.js 4/0AX4XfWh...');
        return;
    }
