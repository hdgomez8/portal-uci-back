...
/**
 * Test de SendGrid - Portal UCI
 * Prueba envío a múltiples destinatarios sin restricciones
 */
...
async function testSendGrid() {
    ...
    try {
        ...
        console.log('1️⃣ Probando envío a múltiples emails...');
        ...
        console.log('2️⃣ Probando envío individual...');
        
        for (const email of testEmails) {
            try {
                const resultado = await enviarCorreo(
                    email,
                    'Test Individual SendGrid - Portal UCI',
                    `
                        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                            <h2 style="color: #2c3e50;">Test Individual SendGrid</h2>
        ...
        console.log('3️⃣ Probando envío múltiple...');
        
        const resultadosMultiples = await enviarCorreoMultiples(
            testEmails,
            'Test Múltiple SendGrid - Portal UCI',
            `
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                    <h2 style="color: #2c3e50;">Test Múltiple SendGrid</h2>
                    <div style="background: #f8f9fa; padding: 20px; border-radius: 8px; margin: 20px 0;">
                        <h3 style="color: #495057; margin-top: 0;">Sistema de Notificaciones</h3>
                        <p><strong>Fecha:</strong> ${new Date().toLocaleString()}</p>
                        <p><strong>API:</strong> SendGrid</p>
