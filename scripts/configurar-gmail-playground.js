...
/**
 * Script para configurar Gmail API usando Google OAuth Playground
 * Este método siempre funciona y no requiere configuración de redirect URI
 */
...
async function configurarGmailAPI() {
    console.log('🔧 CONFIGURANDO GMAIL API CON GOOGLE OAUTH PLAYGROUND');
    console.log('====================================================');
    console.log('');
