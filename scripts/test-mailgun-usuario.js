...
/**
 * Test de Creación de Usuario con Mailgun - Portal UCI
 * Prueba enviando a diferentes emails con Mailgun
 */

const { sendMail } = require('../utils/mailer');
const { getNuevoUsuarioTemplate } = require('../utils/emailTemplates');

async function testMailgunUsuario() {
    console.log('🧪 TEST DE CREACIÓN DE USUARIO CON MAILGUN');
    console.log('==========================================');
    console.log('');
    ...
    try {
        ...
        const empleadoMock = {
            ...
            documento: '12345678',
            email: 'hdgomez0@gmail.com' // Email para pruebas
        };
        ...
        console.log('3️⃣ Enviando correo de bienvenida con Mailgun...');
        ...
        console.log(`   📧 Proveedor: ${resultado.provider}`);
        console.log('');
        ...
        // 5. Resumen del flujo
        console.log('📋 RESUMEN DEL FLUJO DE CREACIÓN DE USUARIO CON MAILGUN');
        console.log('======================================================');
        ...
        console.log('✅ 7. Mailgun API: OK');
        console.log('');
        console.log('🎉 FLUJO COMPLETO FUNCIONANDO CORRECTAMENTE CON MAILGUN');
        console.log('📧 Revisa tu correo para confirmar que el correo de bienvenida llegó');
        console.log('');
        console.log('💡 CARACTERÍSTICAS DEL FLUJO CON MAILGUN:');
        ...
        console.log('   ✅ Mailgun API confiable');
        console.log('   ✅ Manejo de errores robusto');
        console.log('   ✅ Puede enviar a CUALQUIER email');
        console.log('');
        console.log('🚀 PRÓXIMOS PASOS:');
        console.log('   1. El flujo está funcionando perfectamente con Mailgun');
        console.log('   2. Listo para usar en producción');
        console.log('   3. Los usuarios recibirán correos de bienvenida automáticamente');
        console.log('   4. Mailgun puede enviar a cualquier email sin restricciones');

    } catch (error) {
        console.log('');
        console.log('❌ ERROR EN EL TEST DE CREACIÓN DE USUARIO CON MAILGUN');
        console.log('======================================================');
        console.log('Error:', error.message);
        console.log('');
        console.log('🔧 POSIBLES SOLUCIONES:');
        console.log('   1. Verificar configuración de Mailgun API');
        console.log('   2. Verificar que el dominio esté configurado correctamente');
